...
function Signin() {
  ...
  }, [loading, userToken, success, userInfo, error])
      ...
      <form onSubmit={handleSubmit(submitForm)}>
        ...
        <div className="flex gap-1 my-4">
          ...
          <button
            type="button"
            onClick={() =>
              dispatch(toggleSideBar({ open: true, form: 'signup' }))
            }
        ...
        <div className="md:flex md:items-center">
          ...
          <div className="md:w-2/3">
            <button
              disabled={loading}
              type="submit"
              className="shadow bg-gray-900 hover:bg-gray-600 focus:shadow-outline focus:outline-none text-white font-bold py-2 px-4 rounded disabled:opacity-50"
            >
