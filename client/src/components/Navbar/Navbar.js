  ...
  return (
    <nav className="bg-white md:shadow fixed top-0 w-full z-10">
      ...
      <div className="md:hidden my-6 px-8 flex md:justify-center justify-between items-center md:static">
        {/* logo */}
        <Link
          className="text-gray-800 font-bold text-5xl hover:text-gray-800"
          to="/"
        >
          Oh!{' '}
        </Link>
        ...
        >
          ...
          <div className="flex justify-center md:flex-row flex-col my-2 gap-1">
            ...
            {userInfo ? (
              ...
              <button
                onClick={() =>
                  dispatch(toggleSideBar({ form: 'signin', open: true }))
                }
            ...
            >
              <div className="relative">
                ...
                <span className="absolute top-2 left-6 rounded-full bg-indigo-500 text-white p-1 text-xs">
                  {}
                </span>
              </div>
            </button>
            <button className="my-1 text-base text-gray-700 font-medium hover:text-indigo-500 md:mx-4 md:my-0">
              <div className="relative">
